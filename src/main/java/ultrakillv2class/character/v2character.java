package ultrakillv2class.character;
...
import ultrakillv2class.cards.tier0.atkAftershock;
import ultrakillv2class.cards.tier0.atkPulverize;
import ultrakillv2class.cards.tier0.atkStrike;
import ultrakillv2class.cards.tier0.sklDefend;
import ultrakillv2class.relics.rlcPeacekeeperFirmware;

import java.util.ArrayList;

import static ultrakillv2class.ultrakillv2mod.characterPath;
import static ultrakillv2class.ultrakillv2mod.makeID;

public class v2character extends CustomPlayer {
    //Stats
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass ULTRAKILL_ARSENAL;
        @SpireEnum(name = "CHARACTER_VELVET_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_VELVET_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new v2character(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public v2character() {
        super(getNames()[0], Meta.ULTRAKILL_ARSENAL,
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(atkAftershock.ID);
        retVal.add(atkPulverize.ID);

        retVal.add(atkStrike.ID);
        retVal.add(atkStrike.ID);
        retVal.add(atkStrike.ID);

        retVal.add(sklDefend.ID);
        retVal.add(sklDefend.ID);
        retVal.add(sklDefend.ID);
        retVal.add(sklDefend.ID);
        retVal.add(sklDefend.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(rlcPeacekeeperFirmware.ID);
