package ultrakillv2class.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import ultrakillv2class.ultrakillv2mod;
import ultrakillv2class.util.CardStats;
import ultrakillv2class.util.TriFunction;
...
import static ultrakillv2class.util.GeneralUtils.removePrefix;
import static ultrakillv2class.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return ultrakillv2mod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    ultrakillv2mod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
